function EggrollDice() {
    $('.eggroll .vdice-value').each(function () {
        ...
        // Extract modifier from eggroll text, excluding the dice box itself
        const eggrollEl = $(this).closest('.eggroll');
        const modifierText = eggrollEl.clone().children('.vdice-box').remove().end().text();
        ...
        // eggroll-1 → Moves
        // -----------------------------
        if (eggrollEl.hasClass('eggroll-1')) {
            if (finalRoll <= 20) {
                resultText = `
        ...
        // eggroll-2 → Effects
        // -----------------------------
        else if (eggrollEl.hasClass('eggroll-2')) {
            if (finalRoll <= 20) {
                resultText = `
                <img src="https://i.imgur.com/bwjRsaA.png" title="Pokemon Egg">
        ...
        // eggroll-3 → Species
        // -----------------------------
        else if (eggrollEl.hasClass('eggroll-3')) {
            if (finalRoll <= 4) {
                resultText = `
