  ...
  $(document).ready(function () {
    $('.cramomatic-01 .vdice-value').each(function () {
      ...
      if (roll >= 1 && roll <= 10) {
        ...
        <div class="cramomatic-desc">A Safari Ticket fluttered out like a feather.</div>`;
        ...
        <div class="cramomatic-desc">The beak popped open with a Mega Stone!</div>`;
        ...
        <div class="cramomatic-desc">The Cram-o-matic shook and dropped a Legendary Candy!</div>`;
        ...
        <div class="cramomatic-desc">A mysterious Plate gently slid out!</div>`;
        ...
        <div class="cramomatic-desc">A Mythical Pecha Berry plopped onto the ground!</div>`;
        ...
        <div class="cramomatic-desc">Shadow Sludge oozed out of the Cram-o-matic with a burp!</div>`;
        ...
        <div class="cramomatic-desc">A glowing Crystalbloom blasted out of the Cram-o-matic's throat!</div>`;
        ...
        <div class="cramomatic-desc">An Occa Berry plopped onto the ground!</div>`;
        ...
        <div class="cramomatic-desc">A Warden's Ticket fluttered out like a feather!</div>`;
        ...
        <div class="cramomatic-desc">Three gachapon tickets sprayed out like rapid-fire!</div>`;
      } else if (roll === 97) {
        resultText = `
        ...
        <div class="cramomatic-desc">Three premium gachapon tickets sprayed out like rapid-fire!</div>`;
      } else if (roll === 99) {
        resultText = `
